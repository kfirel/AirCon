...
metadata {
  definition(name: "Hisense Air Conditioner", namespace: "kfirel", author: "Dror Eiger", mnmn: "SmartThings", ocfDeviceType: "oic.d.airconditioner", vid: "SmartThings-smartthings-Hisense_Air_Conditioner") {
